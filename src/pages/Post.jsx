...
function Article({ data }) {
	...
	return (
		<>
			...
			{loading ? (
				<div className="W tx-c pd20 b6 bord b-r5 mg-h16">Loading...</div>
			) : failed ? (
				<div className="W tx-c pd20 b6 bord b-r5 mg-h16">An error occurred</div>
			) : (
				<div id="page-content">
								...
								<div className="crayons-article-actions print-hidden">
									<div className="crayons-article-actions__inner">
										...
										<button
											...
											aria-pressed="false"
											className="crayons-reaction crayons-reaction--unicorn activated"
										...
										>
											...
											<span className="crayons-reaction__count" id="reaction-number-unicorn">
										...
										<button
											...
											aria-pressed="false"
											className="crayons-reaction crayons-reaction--readinglist activated"
											...
											<div id="article-show-more-dropdown" className="crayons-dropdown side-bar left-1 s:left-auto m:left-100">
												<div>
													<button
														...
														data-posturl="https://dev.to/ankit01oss/7-github-projects-essential-for-every-javascript-developer-258i"
													>
														...
														>
															<title>Copy article link to the clipboard</title>
												...
												<div className="Desktop-only">
													...
													<a
														...
														className="crayons-link crayons-link--block"
														rel="noreferrer noopener"
														href="https://www.reddit.com/submit?url=https%3A%2F%2Fdev.to%2Fankit01oss%2F7-github-projects-essential-for-every-javascript-developer-258i&amp;title=7%20GitHub%20projects%20essential%20for%20every%20Javascript%20developer%20%F0%9F%91%A8%F0%9F%8F%BD%E2%80%8D%F0%9F%92%BB%20%F0%9F%9A%80"
													>
														Share to Reddit
													</a>
													<a
														...
														className="crayons-link crayons-link--block"
														rel="noreferrer noopener"
														href="https://news.ycombinator.com/submitlink?u=https%3A%2F%2Fdev.to%2Fankit01oss%2F7-github-projects-essential-for-every-javascript-developer-258i&amp;t=7%20GitHub%20projects%20essential%20for%20every%20Javascript%20developer%20%F0%9F%91%A8%F0%9F%8F%BD%E2%80%8D%F0%9F%92%BB%20%F0%9F%9A%80"
													>
													...
													<a
														...
														className="crayons-link crayons-link--block"
														rel="noreferrer noopener"
														href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fankit01oss%2F7-github-projects-essential-for-every-javascript-developer-258i"
													>
														Share to Facebook
													</a>
												</div>
												<web-share-wrapper
													shareurl="https://dev.to/ankit01oss/7-github-projects-essential-for-every-javascript-developer-258i"
													sharetitle="7 GitHub projects essential for every Javascript developer 👨🏽‍💻 🚀"
													sharetext="Javascript is so widely adopted that most developers can't avoid it entirely during the course of..."
													template="web-share-button"
												></web-share-wrapper>
												<template id="web-share-button">
													<a href="/#" className="dropdown-link-row crayons-link crayons-link--block">
														Share Post via...
													</a>
												</template>
												<a href="/report-abuse" className="crayons-link crayons-link--block">
													Report Abuse
												</a>
											</div>
										</div>
										...
										<header className="crayons-article__header" id="main-title">
											...
											<div className="crayons-article__header__meta">
												...
												<div className="mb-4 spec__tags">
													{article.tags.map((tag) => (
														<React.Fragment key={tag}>
															<Link to={'/t/' + tag} key={tag} className="crayons-tag mr-1" style={tags_color[tag] || {}}>
												...
												<div className="crayons-article__subheader">
													<Link
														to={{ pathname: '/' + article.user.username }}
														className="flex items-center mr-2 mb-4 s:mb-0 fw-medium crayons-link"
													>
														<span className="crayons-avatar crayons-avatar--l mr-2">
															<img className="crayons-avatar__image" src={article.user.profile_image_90} alt="" />
														</span>
													...
													<div className="profile-preview-card relative mr-4 mb-4 s:mb-0 fw-medium">
														<button
															...
															className="profile-preview-card__trigger px-0 crayons-btn crayons-btn--ghost hidden m:block"
															aria-label="Ankit Anand ✨ profile details"
															aria-expanded="false"
															aria-controls="profile-preview-content"
															aria-haspopup="true"
															data-initialized="true"
														>
															{article.user.name}
														...
														<div
															...
															className="profile-preview-card__content crayons-dropdown"
															style={{ '--card-color': '#1a1a1a', borderTop: 'var(--su-7) solid var(--card-color)' }}
															...
															<div className="gap-4 grid">
																...
																<div className="print-hidden">
																	<button
																		name="button"
																		type="button"
																		className="bg-btn b-r5 crayons-btn follow-action-button whitespace-nowrap w-100 follow-user showing"
																		data-verb="unfollow"
																		data-click-initialized="true"
																	>
																		Follow
																	</button>
																	&nbsp;
																...
																<div className="user-metadata-details">
																	<ul className="user-metadata-details-inner">
																		<li key="email">
																			...
																			<div className="value">
																				<Link to="mailto:user@email.com" rel="noreferrer noopener" target="_blank">
																					user@email.com
																				</Link>
																			</div>
																		</li>
																		<li key="work">
																			...
																			<div className="value">
																				...
																				<Link to="http://www.example.com" rel="noreferrer noopener" target="_blank">
																					Company
																				</Link>
																			</div>
																		</li>
																		...
																		<li key="joined">
																			...
																			<div className="value">
																				<time dateTime="1970-01-01T12:00:00Z" className="date" title="Date joined">
																					Joined date
																				</time>
																			</div>
																		</li>
													...
													<span className="fs-s mb-4 s:mb-0">
														<time dateTime={article.published_timestamp} className="date-no-year" title="Date published">
